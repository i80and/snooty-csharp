...
public sealed class UriSchemes
{
    public static Dictionary<string, string> SCHEMES = new Dictionary<string, string> {
        ...
        {"eid", (
            "External ID; non-URL data; general escape mechanism to allow " +
            "access to information for applications that are too " +
            "specialized to justify their own schemes"
        )},
        {"fax", (
            "a connection to a terminal that can handle telefaxes " + "(facsimiles); RFC 2806"
        )},
        ...
        {"h323", ("video (audiovisual) communication on local area networks; " + "RFC 3508")},
        {"h324", (
            "video and audio communications over low bitrate connections " +
        ...
        {"mocha", ""},
        {"modem", (
            "a connection to a terminal that can handle incoming data " + "calls; RFC 2806"
        )},
        ...
        {"tcp", ""},
        {"tel", (
            "a connection to a terminal that handles normal voice " +
